...
def pop_db(molecule, intensity_cutoff, temperature):
...
# 	g_ns_dict = {'31P16O':2, '31P32S':2, '14N32S':3, '32S1H':2, '45Sc1H':16,  '27Al16O': 6, '27Al18O': 6 , '26Al16O': 6}
	...
	all=glob.glob(f'*{molecule}*/*{molecule}*')
	list = set()
	[list.add(item.split('.')[0]) for item in all]
	print(list)
	print(all[0].split('.')[0])
...
# 			upper_el.J = data1_statestrans[key][1]
# 			upper_el.Tparity = data1_statestrans[key][2]
# 			upper_el.Rparity = data1_statestrans[key][3]
# 			upper_el.state = data1_statestrans[key][4]
# 			upper_el.v = data1_statestrans[key][5]
# 			upper_el.Lambda = data1_statestrans[key][6]
# 			upper_el.Sigma = data1_statestrans[key][7]
# 			upper_el.Omega = data1_statestrans[key][8]
...
# 			lower_el.J = data1_statestrans[key][11]
# 			lower_el.Tparity = data1_statestrans[key][12]
# 			lower_el.Rparity = data1_statestrans[key][13]
# 			lower_el.state = data1_statestrans[key][14]
# 			lower_el.v = data1_statestrans[key][15]
# 			lower_el.Lambda = data1_statestrans[key][16]
# 			lower_el.Sigma = data1_statestrans[key][17]
# 			lower_el.Omega = data1_statestrans[key][18]
