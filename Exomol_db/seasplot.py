...
data_dict = {'molecule': [], 'exomol ID': [], 'wavenumber': [], 'intensity':[], 'logintensity': [], 'K_mu': [], 'upper J': []}
...
for entry in dbsearch:
	...
	data_dict['logintensity'].append(math.log(entry.intensity))
...
sns.scatterplot(x='wavenumber', y = 'K_mu', hue='molecule', data = data_df)
